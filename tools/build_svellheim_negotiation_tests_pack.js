 ...
 * them into a LevelDB compendium pack at module/packs/svellheim-act2-negotiation-tests/.
 *
...
const PACK_NAME = 'svellheim-act2-negotiation-tests';
const PACK_DIR = path.join(MODULE_DIR, 'packs', PACK_NAME);
const MODULE_ID = 'svellheim-act2';
