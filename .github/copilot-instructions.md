# Svellheim-Act2 — Copilot Instructions

Story beat data for **Act 2** of the Svellheim campaign (Beats 10–18).
...
## Conventions
- File naming: `beat-{NN}-{slug}.json` (e.g., `beat-14-war-council.json`)
